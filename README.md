...
| 120° 分区测试场地 | 全局定位校准 |
| --- | --- |
| <img src="Figs/测试场景2（带地图）.jpg" alt="带分区地图的测试场地" width="520"> | <img src="Figs/3 全局校准.jpg" alt="数字钥匙系统全局校准" width="520"> |

| 整机联调运行 | 门锁控制硬件 |
| --- | --- |
| <img src="Figs/测试场景4.jpg" alt="数字钥匙系统整机联调" width="520"> | <img src="Figs/测试场景5.jpg" alt="门锁控制硬件细节" width="520"> |

## 功能介绍视频

[在项目网站观看五段功能演示](https://qiushi0919.github.io/2026-NUEDC-C/#features)，依次对应题目要求 1、3、4、5、6：
