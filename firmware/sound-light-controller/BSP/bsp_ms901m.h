#ifndef	__BSP_MS901M_H__
#define __BSP_MS901M_H__

#include "board.h"
#include "uart.h"


#define atk_ms901m_uart_send                                MS901M_uart1_send_data
#define atk_ms901m_uart_rx_fifo_read(dat, size)             ringbuffer_getchar(&g_rb_Uart_MS901M_RevBuf, (dat))
